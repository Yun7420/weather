...
export function MainWeatherPanel({
  ...
  return (
    <div className="relative flex min-h-0 min-w-0 w-full flex-[3] basis-0 flex-col rounded-2xl border border-white/12 shadow-2xl shadow-black/40 lg:flex-[2]">
      <div
      ...
      <div className="relative z-10 flex min-h-0 min-w-0 flex-1 flex-col">
        ...
        <div className="flex min-h-0 flex-1 flex-col items-center justify-center overflow-hidden px-4 pb-2 sm:px-6">
